...
#Ubicación ET
setwd("~/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/Unión para hacer un rds y correlaciones/FAPAR/ET Fapar")
...
mas <- mask(resample(ETF, km_Topografic), km_Topografic, method= 'ngb')
mas <- (mas*0.1)
...
writeRaster(Evaporacion1, file="01ETNFA.tif")
writeRaster(Evaporacion2, file="02ETNFA.tif")
writeRaster(Evaporacion3, file="03ETNFA.tif")
writeRaster(Evaporacion4, file="04ETNFA.tif")
writeRaster(Evaporacion5, file="05ETNFA.tif")
writeRaster(Evaporacion6, file="06ETNFA.tif")
writeRaster(Evaporacion7, file="07ETNFA.tif")
writeRaster(Evaporacion8, file="08ETNFA.tif")
writeRaster(Evaporacion9, file="09ETNFA.tif")
writeRaster(Evaporacion10, file="10ETNFA.tif")
writeRaster(Evaporacion11, file="11ETNFA.tif")
writeRaster(Evaporacion12, file="12ETNFA.tif")