...
df01 <- data.frame( Corrpos=Canpos1, corrnes=Canneg1, AreaTotal=areatotal, variable="Correlacion_mas_menos01ssm_fapar")
...
df02 <- data.frame( Corrpos=Canpos2, corrnes=Canneg2, AreaTotal=areatotal, variable="Correlacion_mas_menos03ssm_fapar")
...
df03 <- data.frame( Corrpos=Canpos3, corrnes=Canneg3, AreaTotal=areatotal, variable="Correlacion_mas_menos05ssm_fapar")
...
df04 <- data.frame( Corrpos=Canpos4, corrnes=Canneg4, AreaTotal=areatotal, variable="Correlacion_mas_menos07ssm_fapar")
...
df05 <- data.frame( Corrpos=Canpos5, corrnes=Canneg5, AreaTotal=areatotal, variable="Correlacion_mas_menos09ssm_fapar")

unionTabla12 <- rbind(df01, df02, df03, df04, df05)
unionTabla12 <-unionTabla12[c(-2, -4, -6, -8, -10),]
write.csv(unionTabla12, file ="Correlaciones_anuales_SSM_FAPAR_sdaiteracion.csv")
