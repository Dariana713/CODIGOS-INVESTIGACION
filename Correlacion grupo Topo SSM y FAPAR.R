...
humtopoF <- read.csv("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/TABLAS DE LAS VARIABLES/Tablas Unidas segunda prueba/FAPAR/TablaEstadisticaHumedad_GrupoTopo_de_FAPAR.csv")
...
#min
boxplot(Hum_VegFAPAR$min.x  ~ as.factor(Hum_VegFAPAR$Grupo.x))
#max
boxplot(Hum_VegFAPAR$max.x  ~ as.factor(Hum_VegFAPAR$Grupo.x))
