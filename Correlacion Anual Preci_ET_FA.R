...
sprecF1 <- stack(list.files(pattern = ".tif"))

rstack10 <- stack(sprecF1, ETf)
plot(rstack10)
...
df01 <- data.frame( Corrpos=Canpos1, corrnes=Canneg1, AreaTotal=areatotal, variable="Correlacion_mas_menos01PreET")
...
df02 <- data.frame( Corrpos=Canpos2, corrnes=Canneg2, AreaTotal=areatotal, variable="Correlacion_mas_menos03PreET")
...
df03 <- data.frame( Corrpos=Canpos3, corrnes=Canneg3, AreaTotal=areatotal, variable="Correlacion_mas_menos05PreET")
...
df04 <- data.frame( Corrpos=Canpos4, corrnes=Canneg4, AreaTotal=areatotal, variable="Correlacion_mas_menos07PreET")
...
df05 <- data.frame( Corrpos=Canpos5, corrnes=Canneg5, AreaTotal=areatotal, variable="Correlacion_mas_menos09PreET")

unionTabla11 <- rbind(df01, df02, df03, df04, df05)
unionTabla11 <-unionTabla11[c(-2, -4, -6, -8, -10),]
write.csv(unionTabla11, file ="Correlaciones_anuales36Preci_12ET_FA.csv")
