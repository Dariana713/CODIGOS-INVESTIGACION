...
writeRaster(Tempertaruradia1, file="01TEMPFA.tif")
writeRaster(Tempertaruradia2, file="02TEMPFA.tif")
writeRaster(Tempertaruradia3, file="03TEMPFA.tif")
writeRaster(Tempertaruradia4, file="04TEMPFA.tif")
writeRaster(Tempertaruradia5, file="05TEMPFA.tif")
writeRaster(Tempertaruradia6, file="06TEMPFA.tif")
writeRaster(Tempertaruradia7, file="07TEMPFA.tif")
writeRaster(Tempertaruradia8, file="08TEMPFA.tif")
writeRaster(Tempertaruradia9, file="09TEMPFA.tif")
writeRaster(Tempertaruradia10, file="10TEMPFA.tif")
writeRaster(Tempertaruradia11, file="11TEMPFA.tif")
writeRaster(Tempertaruradia12, file="12TEMPFA.tif")
