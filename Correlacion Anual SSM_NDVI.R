...
df01 <- data.frame( Corrpos=Canpos1, corrnes=Canneg1, AreaTotal=areatotal, variable="Correlacion_mas_menos01_SSM_NDVI")
...
df02 <- data.frame( Corrpos=Canpos2, corrnes=Canneg2, AreaTotal=areatotal, variable="Correlacion_mas_menos03_SSM_NDVI")
...
df03 <- data.frame( Corrpos=Canpos3, corrnes=Canneg3, AreaTotal=areatotal, variable="Correlacion_mas_menos05_SSM_NDVI")
...
df04 <- data.frame( Corrpos=Canpos4, corrnes=Canneg4, AreaTotal=areatotal, variable="Correlacion_mas_menos07_SSM_NDVI")
...
df05 <- data.frame( Corrpos=Canpos5, corrnes=Canneg5, AreaTotal=areatotal, variable="Correlacion_mas_menos09_SSM_NDVI")

unionTabla5 <- rbind(df01, df02, df03, df04, df05)
unionTabla5 <-unionTabla5[c(-2, -4, -6, -8, -10),]
write.csv(unionTabla5, file ="Correlaciones_anuales_SSM_NDVI_2daPrueba.csv")
