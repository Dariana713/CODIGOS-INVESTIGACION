...
setwd("~/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/cOBERTURAS EN FORMATO RASTER")
...
SSM12_21dic2019 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/1_Dia10_enero2020FAPAR_maskCobe.tif")
...
df12dic1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_enero2020FAPAR")
...
df12dic2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_enero2020FAPAR")
...
df12dic3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_enero2020FAPAR")
...
df12dic4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_enero2020FAPAR")
write.csv(df12dic4, file ='4_TablaEstadisticaDia10_enero2020FAPARCobertura_VegetaEscasa.csv')

# Dia 22 dic 2019 al 1 de enero 2020 (11 dias)

SSM22dic2019_1enero2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/2_Dia20_enero2020FAPAR_maskCobe.tif")
...
df22dic1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_enero2020FAPAR")
...
df22dic2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_enero2020FAPAR")
...
df22dic3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_enero2020FAPAR")
...
df22dic4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_enero2020FAPAR")
write.csv(df22dic4, file ='8_TablaEstadisticaDia11_enero2020ndviCobertura_VegetaEscasa.csv')

# Dia 2 al 11 de enero 2020

SSM2_11enero2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/3_Dia31_enero2020FAPAR_maskCobe.tif")
...
df2enero1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_enero2020FAPAR")
...
df2enero2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_enero2020FAPAR")
...
df2enero3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_enero2020FAPAR")
...
df2enero4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_enero2020FAPAR")
write.csv(df2enero4, file ='12_TablaEstadisticaDia21_enero2020ndviCobertura_VegetaEscasa.csv')


# Dia 12 al 21 de enero 2020

SSM12_21enero2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/4_Dia10_febrero2020FAPAR_maskCobe.tif")
...
df12enero1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_febrero2020FAPAR")
...
df12enero2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_febrero2020FAPAR")
...
mediana <- median(na.omit(as.data.frame(MascaraSSM2_11enero2020topo3))[,1])
desvia <- sd(na.omit(as.data.frame(MascaraSSM2_11enero2020topo3))[,1])
df12enero3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_febrero2020FAPAR")
...
df12enero4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_febrero2020FAPAR")
...
SSM22enero_1febr2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/5_Dia20_febrero2020FAPAR_maskCobe.tif")
...
df22enero1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_febrero2020FAPAR")
...
df22enero2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_febrero2020FAPAR")
...
df22enero3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_febrero2020FAPAR")
...
df22enero4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_febrero2020FAPAR")
...
SSM2_11febr2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/6_Dia29_febrero2020FAPAR_maskCobe.tif")
...
df2Febre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia29_febrero2020FAPAR")
...
df2Febre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia29_febrero2020FAPAR")
...
df2Febre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia29_febrero2020FAPAR")
...
df2Febre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia29_febrero2020FAPAR")
...
SSM12_21febr2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/7_Dia10_marzo2020FAPAR_maskCobe.tif")
...
df12Febre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_marzo2020FAPAR")
...
df12Febre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_marzo2020FAPAR")
...
df12Febre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_marzo2020FAPAR")
...
df12Febre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_marzo2020FAPAR")
...
SSM22febr_1Marzo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/8_Dia20_marzo2020fAPAR_maskCobe.tif")
...
df22Febre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_marzo2020fAPAR")
...
df22Febre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_marzo2020fAPAR")
...
df22Febre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_marzo2020fAPAR")
...
df22Febre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_marzo2020fAPAR")
write.csv(df22Febre4, file ='32_TablaEstadisticaDia11_marzo2020ndviCobertura_VegetaEscasa.csv')


# Dia 2 al 11 de Marzo

SSM2_11Marzo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/9_Dia31_marzo2020FAPAR_maskCobe.tif")
...
df2Marzo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_marzo2020FAPAR")
...
df2Marzo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_marzo2020FAPAR")
...
df2Marzo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_marzo2020FAPAR")
...
df2Marzo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_marzo2020FAPAR")
write.csv(df2Marzo4, file ='36_TablaEstadisticaDia21_marzo2020ndviCobertura_VegetaEscasa.csv')

# Dia 12 al 21 de Marzo

SSM12_21Marzo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/10_Dia10_abril2020FAPAR_maskCobe.tif")
...
df12Marzo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_abril2020FAPAR")
...
df12Marzo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_abril2020FAPAR")
...
df12Marzo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_abril2020FAPAR")
...
df12Marzo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_abril2020FAPAR")
...
SSM22Marzo_1abril2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/11_Dia20_abril2020FAPAR_maskCobe.tif")
...
df22Marzo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_abril2020FAPAR")
...
df22Marzo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_abril2020FAPAR")
...
df22Marzo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_abril2020FAPAR")
...
df22Marzo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_abril2020FAPAR")
write.csv(df22Marzo4, file ='44_TablaEstadisticaDia11_abril2020ndviCobertura_VegetaEscasa.csv')


# Dia 2 al 11 de abril

SSM2_11abril2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/12_Dia31_abril2020FAPAR_maskCobe.tif")
...
df2abril1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_abril2020FAPAR")
...
df2abril2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_abril2020FAPAR")
...
df2abril3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_abril2020FAPAR")
...
df2abril4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_abril2020FAPAR")
...
SSM12_21abril2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/13_Dia10_Mayo2020FAPAR_maskCobe.tif")
...
df12abril1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_Mayo2020FAPAR")
...
df12abril2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_Mayo2020FAPAR")
...
df12abril3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_Mayo2020FAPAR")
...
df12abril4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_Mayo2020FAPAR")
write.csv(df12abril4, file ='52_TablaEstadisticaDia1_Mayo2020ndviCobertura_VegetaEscasa.csv')


# Dia 22 de abril al 1 Mayo

SSM22abril_1mayo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/14_Dia20_Mayo2020FAPAR_maskCobe.tif")
...
df22abril1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_Mayo2020FAPAR")
...
df22abril2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_Mayo2020FAPAR")
...
df22abril3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_Mayo2020FAPAR")
...
df22abril4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_Mayo2020FAPAR")
...
SSM2_11mayo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/15_Dia31_Mayo2020FAPAR_maskCobe.tif")
...
df2mayo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_Mayo2020FAPAR")
...
df2mayo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_Mayo2020FAPAR")
...
df2mayo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_Mayo2020FAPAR")
...
df2mayo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_Mayo2020FAPAR")
write.csv(df2mayo4, file ='60_TablaEstadisticaDia21_Mayo2020ndviCobertura_VegetaEscasa.csv')


# Dia 12 al 21 Mayo

SSM12_21mayo2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/16_Dia10_junio2020FAPAR_maskCobe.tif")
...
df12mayo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_junio2020FAPAR")
...
df12mayo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_junio2020FAPAR")
...
df12mayo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_junio2020FAPAR")
...
df12mayo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_junio2020FAPAR")
write.csv(df12mayo4, file ='64_TablaEstadisticaDia1_junio2020ndviCobertura_VegetaEscasa.csv')


# Dia 22 Mayo al 1 Junio

SSM22mayo_1Jumio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/17_Dia20_junio2020FAPAR_maskCobe.tif")
...
df22mayo1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_junio2020FAPAR")
...
df22mayo2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_junio2020FAPAR")
...
df22mayo3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_junio2020FAPAR")
...
df22mayo4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_junio2020FAPAR")
...
SSM2_11Jumio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/18_Dia30_junio2020FAPAR_maskCobe.tif")
...
df2junio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia30_junio2020FAPAR")
...
df2junio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia30_junio2020FAPAR")
...
df2junio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia30_junio2020FAPAR")
...
df2junio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia30_junio2020FAPAR")
...
SSM12_21Jumio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/19_Dia10_julio2020FAPAR_maskCobe.tif")
...
df12junio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_julio2020FAPAR")
...
df12junio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_julio2020FAPAR")
...
df12junio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_julio2020FAPAR")
...
df12junio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_julio2020FAPAR")
...
SSM22Jumio_2julio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/20_Dia20_julio2020FAPAR_maskCobe.tif")
...
df22junio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_julio2020FAPAR")
...
df22junio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_julio2020FAPAR")
...
df22junio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_julio2020FAPAR")
...
df22junio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_julio2020FAPAR")
write.csv(df22junio4, file ='80_TablaEstadisticaDia11_julio2020ndviCobertura_VegetaEscasa.csv')


# Dia 2 al 11 de Julio

SSM2_11julio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/21_Dia31_julio2020FAPAR_maskCobe.tif")
...
df2Julio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_julio2020FAPAR")
...
df2Julio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_julio2020FAPAR")
...
df2Julio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_julio2020FAPAR")
...
df2Julio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_julio2020FAPAR")
write.csv(df2Julio4, file ='84_TablaEstadisticaSSM2_11julio2020Cobertura_VegetaEscasa.csv')


# Dia 12 al 21 de Julio

SSM12_21julio2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/22_Dia10_agosto2020FAPAR_maskCobe.tif")
...
df12Julio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_agosto2020FAPAR")
...
df12Julio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_agosto2020FAPAR")
...
df12Julio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_agosto2020FAPAR")
...
df12Julio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_agosto2020FAPAR")
write.csv(df12Julio4, file ='88_TablaEstadisticaSSM12_21julio2020Cobertura_VegetaEscasa.csv')

# Dia 22 Julio al 1 de Agosto

SSM22julio_1agosto2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/23_Dia20_agosto2020FAPAR_maskCobe.tif")
...
df22Julio1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_agosto2020FAPAR")
...
df22Julio2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_agosto2020FAPAR")
...
df22Julio3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_agosto2020FAPAR")
...
df22Julio4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_agosto2020FAPAR")
write.csv(df22Julio4, file ='92_TablaEstadisticaSSM22julio_1agosto2020Cobertura_VegetaEscasa.csv')


# Dia 2 al 11 de Agosto

SSM2_11agosto2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/24_Dia31_agosto2020FAPAR_maskCobe.tif")
...
df2agosto1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_agosto2020FAPAR")
...
df2agosto2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_agosto2020FAPAR")
...
df2agosto3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_agosto2020FAPAR")
...
df2agosto4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_agosto2020FAPAR")
write.csv(df2agosto4, file ='96_TablaEstadisticaSSM2_11agosto2020Cobertura_VegetaEscasa.csv')


# Dia 12 al 21 de Agosto

SSM12_21agosto2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/25_Dia10_septiembre2020FAPAR_maskCobe.tif")
...
df12agosto1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_septiembre2020FAPAR")
...
df12agosto2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_septiembre2020FAPAR")
...
df12agosto3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_septiembre2020FAPAR")
...
df12agosto4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_septiembre2020FAPAR")
...
SSM22agosto_1septi2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/26_Dia20_septiembre2020FAPAR_maskCobe.tif")
...
df22agosto1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_septiembre2020FAPAR")
...
df22agosto2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_septiembre2020FAPAR")
...
df22agosto3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_septiembre2020FAPAR")
...
df22agosto4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_septiembre2020FAPAR")
...
SSM2_11septi2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/27_Dia30_septiembre2020FAPAR_maskCobe.tif")
...
df2septiembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia30_septiembre2020FAPAR")
...
df2septiembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia30_septiembre2020FAPAR")
...
df2septiembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia30_septiembre2020FAPAR")
...
df2septiembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia30_septiembre2020FAPAR")
write.csv(df2septiembre4, file ='108_TablaEstadisticaSSM2_11septi2020Cobertura_VegetaEscasa.csv')

# Dia 12 al 21 septiembre

SSM12_21septi2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/28_Dia10_octubre2020FAPAR_maskCobe.tif")
...
mediana <- median(na.omit(as.data.frame(MascaraSSM2_11septi2020topo1))[,1])
desvia <- sd(na.omit(as.data.frame(MascaraSSM2_11septi2020topo1))[,1])
df12septiembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_octubre2020FAPAR")
...
df12septiembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_octubre2020FAPAR")
...
df12septiembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_octubre2020FAPAR")
...
df12septiembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_octubre2020FAPAR")
...
SSM12septi2020_1octubre <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/29_Dia20_octubre2020FAPAR_maskCobe.tif")
...
df22septiembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_octubre2020FAPAR")
...
df22septiembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_octubre2020FAPAR")
...
df22septiembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_octubre2020FAPAR")
...
mediana <- median(na.omit(as.data.frame(MascaraSSM12_21septi2020topo4))[,1])
desvia <- sd(na.omit(as.data.frame(MascaraSSM12_21septi2020topo4))[,1])
df22septiembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_octubre2020FAPAR")
...
SSM2_11octubre2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/30_Dia31_octubre2020fapar_maskCobe.tif")
...
df2Octubre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_octubre2020fapar")
...
df2Octubre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_octubre2020fapar")
...
df2Octubre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_octubre2020fapar")
...
df2Octubre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_octubre2020fapar")
write.csv(df2Octubre4, file ='120_TablaEstadisticaSSM2_11octubre2020Cobertura_VegetaEscasa.csv')

# Dia 12 al 21 de octubre

SSM12_21octubre2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/31_Dia10_Noviembre2020FAPAR_maskCobe.tif")
...
df12Octubre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_Noviembre2020FAPAR")
...
df12Octubre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_Noviembre2020FAPAR")
...
mediana <- median(na.omit(as.data.frame(MascaraSSM2_11octubre2020topo3))[,1])
desvia <- sd(na.omit(as.data.frame(MascaraSSM2_11octubre2020topo3))[,1])
df12Octubre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_Noviembre2020FAPAR")
...
df12Octubre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_Noviembre2020FAPAR")
write.csv(df12Octubre4, file ='124_TablaEstadisticaSSM12_21octubre2020Cobertura_VegetaEscasa.csv')


# Dia 22 de octubre 1 de nov 

SSM22octubre_1nov2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/32_Dia20_noviembre2020FAPAR_maskCobe.tif")
...
df22Octubre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_noviembre2020FAPAR")
...
df22Octubre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_noviembre2020FAPAR")
...
df22Octubre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_noviembre2020FAPAR")
...
df22Octubre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_noviembre2020FAPAR")
write.csv(df22Octubre4, file ='128_TablaEstadisticaSSM22octubre_1nov2020Cobertura_VegetaEscasa.csv')


# Dia 2 al 11 de nov 

SSM2_11nov2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/33_Dia31_noviembre2020FAPAR_maskCobe.tif")
...
df2noviembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia31_noviembre2020FAPAR")
...
df2noviembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia31_noviembre2020FAPAR")
...
df2noviembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia31_noviembre2020FAPAR")
...
df2noviembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia31_noviembre2020FAPAR")
write.csv(df2noviembre4, file ='132_TablaEstadisticaSSM2_11nov2020Cobertura_VegetaEscasa.csv')

# Dia 12 al 21 de nov 

SSM12_21nov2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/34_Dia10_diciembre2020FAPAR_maskCobe.tif")
...
df12noviembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia10_diciembre2020FAPAR")
...
df12noviembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia10_diciembre2020FAPAR")
...
df12noviembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia10_diciembre2020FAPAR")
...
df12noviembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia10_diciembre2020FAPAR")
...
SSM22nov_1dici2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/35_Dia20_diciembre2020FAPAR_maskCobe.tif")
...
desvia <- sd(na.omit(as.data.frame(MascaraSSM12_21nov2020topo))[,1])
df22noviembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia20_diciembre2020FAPAR")
...
df22noviembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia20_diciembre2020FAPAR")
...
df22noviembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia20_diciembre2020FAPAR")
...
df22noviembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia20_diciembre2020FAPAR")
...
SSM2_11dici2020 <- raster("C:/Users/Usuario/Documents/Análisis de Tesis en Rstudio y SAGA GIS/Codigos de estadisticas/CARPETA DE TRABAJO ACTUALIZADA AL DIA/FAPAR/36 DIAS DE FAPAR/Dia36_diciembre2020FAPAR_maskCobe.tif")
...
df2diciembre1 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="CoberturaBosque", variable= "Dia36_diciembre2020FAPAR")
...
df2diciembre2 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Matorral", variable= "Dia36_diciembre2020FAPAR")
...
df2diciembre3 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_Pastizal", variable= "Dia36_diciembre2020FAPAR")
...
df2diciembre4 <- data.frame(min=minimo, max=maximo, mean=medio, median=mediana, sd= desvia, Grupo="Cobertura_VegetaEscasa", variable= "Dia36_diciembre2020FAPAR")
...
write.csv(unionTabla, file ='TablaFAPAR_CoberturaVegetal.csv')
